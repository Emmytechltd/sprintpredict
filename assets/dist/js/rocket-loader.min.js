! function() {
    ...
    function m(t) {
        var e = new I(t),
            n = new _(e);
        e.harvestScriptsInDocument(), new C(e, {
            blocking: !0,
            docWriteSimulator: n,
            callback: function() {}
        }).run()
    ...
    function y(t) {
        ...
        var r = new C(e, {
            ...
            docWriteSimulator: n,
            callback: function() {
                r.removePreloadHints(), b(t)
            }
        });
        r.insertPreloadHints(), D.runOnLoad(function() {
            r.run()
        })
    }
    ...
    function b(t) {
        var e = new L(t);
        D.simulateStateBeforeDeferScriptsActivation(), e.harvestDeferScriptsInDocument(), new C(e, {
            blocking: !1,
            callback: function() {
                D.simulateStateAfterDeferScriptsActivation(), O && O()
            }
        }).run()
    }
    ...
    instanceof Array && function(t, e) {
        ...
        return h(e, t), e.prototype.harvestScriptsInDocument = function() {
            var t = this;
        ...
        return h(e, t), e.prototype.harvestDeferScriptsInDocument = function() {
            var t = this;
            this.harvestScripts(document, {
                filter: function(e) {
        ...
        return t.prototype.enable = function(t) {
            ...
            document.write = P, document.writeln = k, this.buffer.length && (document.contains(this.insertionPointMarker) ? this.insertionPointMarker.parentNode === document.head ? this.insertContentInHead() : this.insertContentInBody() : e("Insertion point marker for document.write was detached from document:", "Markup will not be inserted"))
        }, t.prototype.insertContentInHead = function() {
            var t = new DOMParser,
                e = "<!DOCTYPE html><head>" + this.buffer + "</head>",
                i = t.parseFromString(e, "text/html");
            if (this.scriptStack.harvestScriptsAfterDocWrite(i), n(i.head.childNodes, this.insertionPointMarker), i.body.childNodes.length) {
                for (var o = Array.prototype.slice.call(i.body.childNodes), a = this.insertionPointMarker.nextSibling; a;) o.push(a), a = a.nextSibling;
                document.body || P.call(document, "<body>"), r(o, document.body)
            }
        ...
        function t() {
            ...
            this.createConditionalEventListenerProxy(document, ["DOMContentLoaded", "readystatechange"]), this.createConditionalEventListenerProxy(window, ["load"]), this.updateInlineHandlers()
        }
            ...
            t.addEventListener = function(i, o) {
                ...
                if (!s) {
                    ...
                    if ("function" == typeof u) {
                        var p = n;
                        s = function(t) {
                            if (p.bypassEventsInProxies || e.indexOf(i) < 0) return u.call(this, t)
                ...
                var a = n.__rocketLoaderProxiedHandler || n;
        ...
        return t.prototype.insertPreloadHints = function() {
            ...
            this.scriptStack.forEach(function(e) {
                ...
                if (n) {
                    ...
                    r.setAttribute("rel", "preload"), r.setAttribute("as", "script"), r.setAttribute("href", n), e.crossOrigin && r.setAttribute("crossorigin", e.crossOrigin), document.head.appendChild(r), t.preloadHints.push(r)
                }
            })
            ...
            this.settings.docWriteSimulator && !t.async && this.settings.docWriteSimulator.flushWrittenContentAndDisable(), D.updateInlineHandlers(), i(t.placeholder)
    ...
    ! function() {
        ...
        if (t) {
            ...
            if (n) {
                ...
                i(t), D.updateInlineHandlers(), r ? m(n) : (v(), y(n))
            } else e("Activator script doesn't have nonce. No scripts will be executed.")
